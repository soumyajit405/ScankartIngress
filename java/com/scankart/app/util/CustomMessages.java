...
public class CustomMessages {
	...
	public static String getCustomMessages(String code)
	{
		...
		if(code.equalsIgnoreCase("IV"))
		{
			return "Invalid credentials.";
		}
		if(code.equalsIgnoreCase("MLA"))
		{
			return "Max Sessions Exceeded. Cannot login.";
		}
		else if(code.equalsIgnoreCase("USE"))
		{
			return "User Already Existed.";
		}
		else if(code.equalsIgnoreCase("UAU"))
		{
			return "UnAuthorised User.";
		}
		else if(code.equalsIgnoreCase("USEE"))
		{
