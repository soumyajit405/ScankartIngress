...
public class BusinessAttributesTypePl implements Serializable {
	...
	private List<AllMerchantAttribute> allMerchantAttr;
	...
	public List<AllMerchantAttribute> getAllMerchantAttr() {
		return allMerchantAttr;
	}

	public void setAllMerchantAttr(List<AllMerchantAttribute> allMerchantAttr) {
		this.allMerchantAttr = allMerchantAttr;
	}
